package com.godpaper.as3.consts
{
	 ...
	 *
	 */	
	public class DefaultPiecesConstants extends Enum
	{
		{initEnum(DefaultPiecesConstants);}//static construct.
		//--------------------------------------------------------------------------
		//
		//  Variables
		//
		...
		//chessPieceType
		//blue(at top)
		public static const BLUE:DefaultPiecesConstants = new DefaultPiecesConstants("-",0,0);//default-
		public static const BLUE_PAWN:DefaultPiecesConstants=new DefaultPiecesConstants("p", 22, 30); //pawn-
		public static const BLUE_ROOK:DefaultPiecesConstants=new DefaultPiecesConstants("r", 20, 600); //castle-
		public static const BLUE_KNIGHT:DefaultPiecesConstants=new DefaultPiecesConstants("k", 19, 270); //knight-
		public static const BLUE_BISHOP:DefaultPiecesConstants=new DefaultPiecesConstants("b", 18, 120); //bishop-
		public static const BLUE_OFFICAL:DefaultPiecesConstants=new DefaultPiecesConstants("o", 16, 120); //offcial-
		public static const BLUE_MARSHAL:DefaultPiecesConstants=new DefaultPiecesConstants("m", 17, 6000); //marshal-
		public static const BLUE_CANNON:DefaultPiecesConstants=new DefaultPiecesConstants("c", 21, 285); //cannon-
		//red(at bottom)
		public static const RED:DefaultPiecesConstants = new DefaultPiecesConstants("+",0,0);//default+
		public static const RED_PAWN:DefaultPiecesConstants=new DefaultPiecesConstants("P", 14, 30); //pawn+
		public static const RED_ROOK:DefaultPiecesConstants=new DefaultPiecesConstants("R", 12, 600); //castle+
		public static const RED_KNIGHT:DefaultPiecesConstants=new DefaultPiecesConstants("K", 11, 270); //knight+
		public static const RED_BISHOP:DefaultPiecesConstants=new DefaultPiecesConstants("B", 10, 120); //bishop+
		public static const RED_OFFICAL:DefaultPiecesConstants=new DefaultPiecesConstants("O", 8, 120); //offcial+
		public static const RED_MARSHAL:DefaultPiecesConstants=new DefaultPiecesConstants("M", 9, 6000); //marshal+
		public static const RED_CANNON:DefaultPiecesConstants=new DefaultPiecesConstants("C", 13, 285); //cannon+
		//--------------------------------------------------------------------------
		//
		//  Constructor
		//
		...
		//
		final public function DefaultPiecesConstants(label:String,value:int,strength:int=-1,important:Array2=null,convertedImportant:Array2=null)
		{
			this.label = label;
			this.value = value;
