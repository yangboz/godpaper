package com.godpaper.the_chess_jam.consts
{
	 ...
	 * @langVersion 3.0
	 * @playerVersion 9.0
	 * Created Sep 18, 2011 04:19:44 PM
	 */
	final public class PiecesConstants_TheChessJam extends Enum
	{
		//--------------------------------------------------------------------------
		//
		//  Variables
		...
		//chessPieceType
		//blue(at top)
		public static const BLUE_PAWN:PiecesConstants_TheChessJam=new PiecesConstants_TheChessJam("p", 22, 30); //pawn-
		public static const BLUE_ROOK:PiecesConstants_TheChessJam=new PiecesConstants_TheChessJam("r", 20, 600); //castle-
		public static const BLUE_KNIGHT:PiecesConstants_TheChessJam=new PiecesConstants_TheChessJam("k", 19, 270); //knight-
		public static const BLUE_BISHOP:PiecesConstants_TheChessJam=new PiecesConstants_TheChessJam("b", 18, 120); //bishop-
//		public static const BLUE_OFFICAL:PiecesConstants_TheChessJam=new PiecesConstants_TheChessJam("o", 16, 120); //offcial-
		public static const BLUE_MARSHAL:PiecesConstants_TheChessJam=new PiecesConstants_TheChessJam("m", 17, 6000); //marshal-
		public static const BLUE_QUEEN:PiecesConstants_TheChessJam=new PiecesConstants_TheChessJam("q", 21, 285); //queen-
		//red(at bottom)
		public static const RED_PAWN:PiecesConstants_TheChessJam=new PiecesConstants_TheChessJam("P", 14, 30); //pawn+
		public static const RED_ROOK:PiecesConstants_TheChessJam=new PiecesConstants_TheChessJam("R", 12, 600); //castle+
		public static const RED_KNIGHT:PiecesConstants_TheChessJam=new PiecesConstants_TheChessJam("K", 11, 270); //knight+
		public static const RED_BISHOP:PiecesConstants_TheChessJam=new PiecesConstants_TheChessJam("B", 10, 120); //bishop+
//		public static const RED_OFFICAL:PiecesConstants_TheChessJam=new PiecesConstants_TheChessJam("O", 8, 120); //offcial+
		public static const RED_MARSHAL:PiecesConstants_TheChessJam=new PiecesConstants_TheChessJam("M", 9, 6000); //marshal+
		public static const RED_QUEEN:PiecesConstants_TheChessJam=new PiecesConstants_TheChessJam("Q", 13, 285); //queen+
		//--------------------------------------------------------------------------
		//
		//  Public properties
		//
		...
		//
		//--------------------------------------------------------------------------
		public function PiecesConstants_TheChessJam(label:String, value:int, strength:int=-1, important:Array2=null, convertedImportant:Array2=null)
		{
