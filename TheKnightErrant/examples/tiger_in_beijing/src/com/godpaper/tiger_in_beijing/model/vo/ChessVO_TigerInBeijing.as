package tiger_in_beijing.src.com.godpaper.tiger_in_beijing.model.vo
{
	//--------------------------------------------------------------------------
	//
	//  Imports
	...
	{		
		...
		//
		//--------------------------------------------------------------------------
		public function ChessVO_TigerInBeijing(width:int, height:int, rowIndex:int, colIndex:int, flag:uint=0)
		{
