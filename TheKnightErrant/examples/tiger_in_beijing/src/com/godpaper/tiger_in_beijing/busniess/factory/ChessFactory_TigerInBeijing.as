package tiger_in_beijing.src.com.godpaper.tiger_in_beijing.busniess.factory
{
	//--------------------------------------------------------------------------
	//
	//  Imports
	...
	import tiger_in_beijing.src.com.godpaper.tiger_in_beijing.model.vo.ChessVO_TigerInBeijing;
	 ...
	 */   	 
	public class ChessFactory_TigerInBeijing extends ChessFactoryBase
	{		
		//--------------------------------------------------------------------------
		//
		//  Variables
		...
		//
		//--------------------------------------------------------------------------
		public function ChessFactory_TigerInBeijing()
		{
		...
		override public function generateChessVO(conductVO:ConductVO):IChessVO
		{
			...
			switch ((conductVO.target as ChessPiece).label)
			{
				case DefaultPiecesConstants.BLUE.label:
					chessVO=new ChessVO_TigerInBeijing(BoardConfig.xLines,BoardConfig.yLines,oRowIndex, oColIndex,DefaultConstants.FLAG_BLUE);
					break;
				case DefaultPiecesConstants.RED.label:
					chessVO=new ChessVO_TigerInBeijing(BoardConfig.xLines,BoardConfig.yLines, oRowIndex, oColIndex,DefaultConstants.FLAG_RED);
					break;
				default:
					break;
			}
