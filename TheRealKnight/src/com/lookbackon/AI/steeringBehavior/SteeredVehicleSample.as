package com.lookbackon.AI.steeringBehavior
{
	 ...
	 * 
	 */	
	public class SteeredVehicleSample extends VehicleSample
	{
		...
		public function SteeredVehicleSample()
		{
		...
		public function pursue(target:VehicleSample):void
		{
		...
		public function evade(target:VehicleSample):void
		{
			var lookAheadTime:Number = position.dist(target.position) / _maxSpeed;
		...
		public function flock(vehicles:Array):void
		{
			...
			{
				var vehicle:VehicleSample = vehicles[i] as VehicleSample;
		...
		public function inSight(vehicle:VehicleSample):Boolean		
		{
		...
		public function tooClose(vehicle:VehicleSample):Boolean
		{
